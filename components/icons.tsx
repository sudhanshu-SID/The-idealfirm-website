...
// Service Icons
export const GoogleAdsIcon: React.FC<{className?: string}> = ({ className = "h-8 w-8 text-brand-primary" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
    </svg>
);

export const FacebookAdsIcon: React.FC<{className?: string}> = ({ className = "h-8 w-8 text-brand-primary" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const WebDesignIcon: React.FC<{className?: string}> = ({ className = "h-8 w-8 text-brand-primary" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
    </svg>
);

export const SEOIcon: React.FC<{className?: string}> = ({ className = "h-8 w-8 text-brand-primary" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
    </svg>
);

export const SocialMediaIcon: React.FC<{className?: string}> = ({ className = "h-8 w-8 text-brand-primary" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const ContentMarketingIcon: React.FC<{className?: string}> = ({ className = "h-8 w-8 text-brand-primary" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
// Industry Icons
const IconWrapper: React.FC<{ children: React.ReactNode }> = ({ children }) => <div className="p-4 bg-gray-100 rounded-full">{children}</div>;
...
export const ShowroomIcon: React.FC = () => (
     <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h6m-6 4h6m-6 4h6" />
    </svg>
);
export const AutomobileIcon: React.FC = () => (
     <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H3m14 8a4 4 0 11-8 0 4 4 0 018 0z" />
    </svg>
);
export const ManufacturerIcon: React.FC = () => (
     <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h6m-6 4h6m-6 4h6" />
    </svg>
);
export const HospitalityIcon: React.FC = () => (
     <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h6m-6 4h6m-6 4h6" />
    </svg>
);
...
// Footer Social Icons
export const FacebookIcon: React.FC<{footer?: boolean}> = ({footer}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-${footer ? 6 : 8} w-${footer ? 6 : 8}`} fill="currentColor" viewBox="0 0 24 24">
        <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v2.385z" />
    </svg>
);
export const TwitterIcon: React.FC<{footer?: boolean}> = ({footer}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-${footer ? 6 : 8} w-${footer ? 6 : 8}`} fill="currentColor" viewBox="0 0 24 24">
        <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.588-7.52 2.588-.49 0-.974-.03-1.451-.086 2.685 1.725 5.872 2.73 9.284 2.73 11.18 0 16.533-9.254 16.533-16.534 0-.251 0-.501-.015-.748.995-.718 1.858-1.62 2.55-2.65z" />
    </svg>
);
export const LinkedInIcon: React.FC<{footer?: boolean}> = ({footer}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-${footer ? 6 : 8} w-${footer ? 6 : 8}`} fill="currentColor" viewBox="0 0 24 24">
        <path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.98v16h4.98v-8.396c0-2.018 1.484-2.845 3.014-2.845 1.055 0 2.002.57 2.002 2.833v8.408h4.98v-8.835c0-4.454-2.316-6.669-5.463-6.669-2.52 0-3.532 1.312-4.018 2.5z" />
    </svg>
);
export const InstagramIcon: React.FC<{footer?: boolean}> = ({footer}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-${footer ? 6 : 8} w-${footer ? 6 : 8}`} fill="currentColor" viewBox="0 0 24 24">
